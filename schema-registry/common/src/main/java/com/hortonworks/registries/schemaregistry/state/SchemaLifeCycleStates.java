...
/**
 * todo we should have the state flow of a specific version stored so that it can be seen how a specific version
...
public final class SchemaLifeCycleStates {
    ...
    public static class Registry {
        ...
        public SchemaLifeCycleState get(Byte stateId) {

...
public class ConfluentSchemaRegistryCompatibleResource extends BaseRegistryResource {
    ...
    private static final Response SERVER_ERROR = Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                                                         .entity(new ErrorMessage(SERVER_ERROR_CODE, " Error in the backend datastore\n"))
                                                         .build();

    public static final int SUBJECT_NOT_FOUND_ERROR_CODE = 40401;
    private static final Response SUBJECT_NOT_FOUND_ERROR = Response.status(Response.Status.NOT_FOUND)
                                                                    .entity(new ErrorMessage(SUBJECT_NOT_FOUND_ERROR_CODE, "Subject not found"))
                                                                    .build();

    public static final int VERSION_NOT_FOUND_ERROR_CODE = 40402;
    private static final Response VERSION_NOT_FOUND_ERROR = Response.status(Response.Status.NOT_FOUND)
                                                                    .entity(new ErrorMessage(VERSION_NOT_FOUND_ERROR_CODE, "Version not found"))
                                                                    .build();

    public static final int SCHEMA_NOT_FOUND_ERROR_CODE = 40403;
    private static final Response SCHEMA_NOT_FOUND_ERROR = Response.status(Response.Status.NOT_FOUND)
                                                                   .entity(new ErrorMessage(SCHEMA_NOT_FOUND_ERROR_CODE, "Schema not found"))
                                                                   .build();

    public static final int INVALID_SCHEMA_ERROR_CODE = 42201;
    public static final int INVALID_SCHEMA_RESPONSE_STATUS = 422;
    private static final Response INVALID_SCHEMA_ERROR = Response.status(INVALID_SCHEMA_RESPONSE_STATUS)
                                                                 .entity(new ErrorMessage(INVALID_SCHEMA_ERROR_CODE, "Invalid Avro schema"))
                                                                 .build();

    public static final int INCOMPATIBLE_SCHEMA_ERROR_CODE = 40901;
    private static final Response INCOMPATIBLE_SCHEMA_ERROR = Response.status(Response.Status.CONFLICT)
                                                                      .entity(new ErrorMessage(INCOMPATIBLE_SCHEMA_ERROR_CODE, "Incompatible Avro schema"))
                                                                      .build();
    ...
    @Timed
    public Response getSchemaById(@ApiParam(value = "SchemaVersionEntry id", required = true) @PathParam("id") Long id) {
        Response response;
        try {
            ...
            response = SCHEMA_NOT_FOUND_ERROR;
        } catch (Exception ex) {
    ...
    @ApiOperation(value = "Get all registered subjects",
            response = String.class, responseContainer = "Collection", tags = OPERATION_GROUP_SCHEMA)
    @Timed
    ...
    @ApiOperation(value = "Get all registered subjects",
            response = Integer.class, responseContainer = "Collection", tags = OPERATION_GROUP_SCHEMA)
    @Timed
    public Response getAllVersions(@ApiParam(value = "subject", required = true)
        ...
        try {
            ...
            response = SUBJECT_NOT_FOUND_ERROR;
        } catch (Exception ex) {
            LOG.error("Encountered error while retrieving all subjects", ex);
            response = SERVER_ERROR;
        }
    ...
    public Response getSchemaVersion(@ApiParam(value = "subject", required = true)
        ...
        try {
            ...
            response = VERSION_NOT_FOUND_ERROR;
        } catch (Exception ex) {
            LOG.error("Encountered error while retrieving all subjects", ex);
            response = SERVER_ERROR;
        }
    ...
    public Response registerSchema(@ApiParam(value = "subject", required = true) @PathParam("subject")
        ...
        return handleLeaderAction(uriInfo, () -> {
            ...
            try {
                ...
                response = INCOMPATIBLE_SCHEMA_ERROR;
